...
test = "full_test"
for m in methods:
    print sum(precision[test][m.method_name]), sum(error[test][m.method_name]), sum(
        topological_error[test][m.method_name]), sum(ranking[test][m.method_name]), m.method_name
test = "random_test"
for m in methods:
    print sum(precision[test][m.method_name]), sum(error[test][m.method_name]), sum(
        topological_error[test][m.method_name]), sum(ranking[test][m.method_name]), m.method_name
