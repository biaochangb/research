...
import map_likelihoods as enum
...
if __name__ == '__main__':
    ...
    methods = [enum.Likelihoods(prior_detector1), ulbaa.ULBAA(prior_detector1),gsba.GSBA(prior_detector1)]
    ...
    logger = log.Logger(logname='../data/main_ulbaa.log', loglevel=logging.INFO, logger="experiment").get_log()
    ...
    experiment.start(d, test_category, test_num, 5, 7, 10)
